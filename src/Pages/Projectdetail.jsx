...
import logoWithoutLine from "../assets/logo_without_line.bdc589508ea85f49e393.png";

import thumb1 from "../assets/thumbnail.d0b239cb31a71fddda97.png";
import thumb2 from "../assets/thumbnail.73a6e1c0b285dc8da1bb.png";
import thumb3 from "../assets/thumbnail.e5848ea560566193af26 (1).png";
import thumb4 from "../assets/thumbnail.6f34ac1ec8fcf101dbb1.png";
import thumb5 from "../assets/thumbnail.27d52a9ae2040f8ed4a4.png";
import thumb6 from "../assets/thumbnail.dadec973137d43c0fcb9.png";
import thumb7 from "../assets/thumbnail.3e3ccf792ad1e6e8f90b.png";
import thumb8 from "../assets/thumbnail.cef3f20ac5ce8c2c56f3.png";
import thumb9 from "../assets/thumbnail.611b66e244e2ee3ea3a2.png";
...
const projects = [
  ...
  },
  {
    img: thumb4,
    title:
      "Explore BrainStormer’s Smooth Design & Engaging Quiz Flow — Built for Learners!",
  },
  {
    img: thumb5,
    title:
      "Manthar: The Smartest Way to Plan, Book, and Travel — Seamlessly in Pakistan",
  },
  {
    img: thumb6,
    title:
      "SLOVE: A Global Platform for Music Lovers — Discover, Connect, and Share!",
  },
  {
    img: thumb7,
    title:
      "Experience BrainStormer — The Interactive UI Behind Smarter Learning Games",
  },
  {
    img: thumb8,
    title:
      "Manthar App: Effortless Bus Ticket Booking with a Clean, Modern Interface",
  },
  {
    img: thumb9,
    title:
      "SLOVE — Bringing the World’s Music Closer, One Stream at a Time",
  },
];

const Project = () => {
  return (
    <section id="project" className="overflow-x-hidden bg-white">
      {/* ===== HERO SECTION ===== */}
      <div className="w-full h-56 bg-gray-100 flex items-center justify-center">
        <h1 className="font-bold text-5xl text-blue-950 tracking-tight">
          Projects
        </h1>
      </div>
      ...
      {/* ===== PROJECT GRID ===== */}
      <div className="flex flex-wrap justify-center gap-10 p-10 lg:p-20">
        {projects.map((item, i) => (
          <div
            key={i}
            className="w-[340px] md:w-[360px] group hover:-translate-y-1 transition-transform"
          >
            <div className="relative">
              <img
                src={logoWithoutText}
                alt="logo"
                className="w-16 absolute top-2 left-2 transition-transform duration-300 group-hover:scale-105"
              />
              <img
                src={item.img}
                alt="thumbnail"
                className="rounded-2xl w-full h-[230px] object-cover transition-transform duration-500 group-hover:scale-105"
              />
            </div>

            <div className="flex justify-between items-center mt-3">
              <h1 className="w-64 font-semibold text-gray-800 cursor-pointer group-hover:text-orange-500 transition-colors duration-300">
                {item.title}
              </h1>
              <Link to="/projectdetails">
                <button className="rounded-full w-10 h-10 border border-orange-400 hover:bg-orange-400 flex items-center justify-center transition">
      ...
      <section
        id="contact"
        className="w-full flex items-start justify-center bg-white px-6 py-20"
      >
        <div className="flex flex-col lg:flex-row gap-8 max-w-6xl w-full">
          ...
          <div className="flex flex-col w-full max-w-xl">
            ...
            <p className="text-lg text-gray-700">
              We love making new connections! Whether you want to say hi,
              collaborate, or start a project — we’d love to hear from you.
            </p>
          </div>

          {/* Form Side */}
          <form className="bg-gradient-to-tr from-[#ED8B29] to-[#FFD23F] rounded-3xl px-8 py-10 flex flex-col gap-5 w-full max-w-xl shadow-lg">
            <input
              type="text"
              placeholder="Your name*"
              required
              className="w-full bg-[#FFE0B2] py-3 px-5 rounded-full placeholder:text-[#000B27] text-[#000B27] focus:outline-none focus:ring-2 focus:ring-[#000B27]/50"
            />
            <input
              type="email"
            ...
            <textarea
              ...
              required
              className="w-full bg-[#FFE0B2] px-5 py-4 rounded-xl placeholder:text-[#000B27] text-[#000B27] focus:outline-none focus:ring-2 focus:ring-[#000B27]/50 resize-none h-32"
            ></textarea>
            ...
            <button
              type="submit"
              className="bg-[#000B27] rounded-full py-2 px-10 text-white w-fit mt-3 hover:scale-105 transition-transform duration-300"
            >
              Send
            </button>
          </form>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-6 lg:py-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex gap-5 text-gray-500">
              {[Facebook, MessageCircle, Twitter, Github, Dribbble].map(
                (Icon, i) => (
                  <a key={i} href="#" className="hover:text-gray-900 transition">
