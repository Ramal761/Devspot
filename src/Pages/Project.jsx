...
const Project = () => {
  const projects = [
    { img: thumb1, title: "Unleash Your Mind with BrainStormer: Exploring the UI Design of a Cutting-Edge Quiz App" },
    { img: thumb2, title: "Manthar – Your Ultimate Companion for Hassle-Free Online Bus Ticket Booking Across Pakistan" },
    { img: thumb3, title: "Welcome to SLOVE – Your Ultimate Destination for Streaming, Sharing, and Discovering Music Worldwide" },
    { img: thumb4, title: "Unleash Your Mind with BrainStormer: Exploring the UI Design of a Cutting-Edge Quiz App" },
    { img: thumb5, title: "Manthar – Your Ultimate Companion for Hassle-Free Online Bus Ticket Booking Across Pakistan" },
    { img: thumb6, title: "Welcome to SLOVE – Your Ultimate Destination for Streaming, Sharing, and Discovering Music Worldwide" },
    { img: thumb7, title: "Unleash Your Mind with BrainStormer: Exploring the UI Design of a Cutting-Edge Quiz App" },
    { img: thumb8, title: "Manthar – Your Ultimate Companion for Hassle-Free Online Bus Ticket Booking Across Pakistan" },
    { img: thumb9, title: "Welcome to SLOVE – Your Ultimate Destination for Streaming, Sharing, and Discovering Music Worldwide" },
  ];

  return (
    <section id="project" className="h-screen overflow-x-hidden">
      <div className="w-full h-56 bg-gray-100">
        <h1 className="p-30 font-bold text-4xl text-blue-950">Projects</h1>
      </div>
