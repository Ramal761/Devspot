...
// ✅ Import all images properly from src/assets
import blog1 from "../assets/blog1.292ece9c470db3ac47b9.jpeg";
import blog2 from "../assets/blog2.4243bf02ca200433663e.jpeg";
import blog3 from "../assets/blog3.0cf2c14f949b3fb3778a.jpeg";
import blog4 from "../assets/blog4.3f0ee18977cfd8965323.jpeg";
import blog5 from "../assets/blog5.d639e3a09f1f6995d30b.jpeg";
...
const Blog = () => {
  return (
    <section id="blogs" className="w-screen overflow-x-hidden">
        ...
        {[
          {
            ...
            desc: "In the ever-evolving world of web development, trends come and go, but React has consistently held its ground as the leading...",
          },
          {
            img: blog2,
            title:
              "Unlocking ROI: How Strategic Application Development Drives Business Growth",
            desc: "Strategic application development is a disciplined approach where every technical decision maps back to business objectives...",
          },
          {
            img: blog3,
            title:
              "From Creativity to Automation: Uses and Opportunities of Generative AI",
            desc: "Generative artificial intelligence is reshaping how organisations and creators solve problems. Once mostly confined to labs...",
          },
          {
            img: blog4,
            title:
              "Why Backend Optimization Matters More Than Ever in 2025",
            desc: "In a digital world where attention spans are shorter than ever, performance is everything. Whether someone is using a SaaS...",
          },
          {
            img: blog5,
            title:
              "Deploying Smarter — Lessons I Learned from Real-World AWS Projects",
            desc: "Deployment is one of those stages in software development that can either make or break a project. You can write the cleanest...",
          },
        ].map((blog, index) => (
          <div
            key={index}
            className="flex flex-col w-96 h-[600px] border-2 border-gray-100 rounded-md"
          >
            <img className="m-5 rounded-md h-60" src={blog.img} alt={blog.title} />
            <h1 className="text-2xl ml-6 font-semibold hover:text-orange-400 cursor-pointer">
              {blog.title}
            </h1>
            <p className="text-[18px] m-5 text-blue-950">{blog.desc}</p>
            <Link to="/blogdetails">
      ...
      <section
        id="contact"
        className="w-full min-h-screen flex items-start justify-center bg-white px-6 mt-20"
      >
          ...
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="#/" className="flex items-center">
                <img src={logo} className="h-12 me-3" alt="Devspots Logo" />
              </a>
            </div>
