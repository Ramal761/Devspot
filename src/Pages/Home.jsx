...
const Home= () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      else if (window.innerWidth < 768) setVisibleCount(2); // sm
      else if (window.innerWidth < 1024) setVisibleCount(3); // md
...
//           transition: "all 1s ease-out",
//         }}
//         className=" lg:flex-row  flex md:flex-col sm:flex-col flex-col lg:p-32 md:p-20 sm:p-16 p-20 ">
//   <div className="flex flex-col">
//     <h1 className="text-8xl w-[800px] text-blue-950 font-bold">From Idea to<br/>
//         <span className="text-yellow-500">delivery</span> </h1>
//      <p className=" w-[550px] p-3 text-4xl text-blue-950">Unlock the full potential of your project with our company</p>
//      <div className="text-[18px] w-[500px] font-semibold flex flex-col gap-3 text-blue-950 p-5 ">
//        <p>Quality Product</p>
//         <p>Latest Technology Stack</p>
//        <p>Trusted by Startups to Fortune 500</p>
//        <p>Faster Time to Market with an Agile Approach</p>
//        <p>Top-tier Data Security Protocols</p>
//        <p>On-time Delivery, No Surprises</p></div>
//   </div>

//        <div className="flex flex-col">
//      <div className="flex gap-4">
//     <div class="rounded-full shadow-lg flex flex-col justify-center w-60 h-60  text-center items-center    mt-9">
//         <h1 class="text-yellow-500  font-extrabold text-3xl ">10</h1>
//         <p class=" font-semibold text-xl  text-blue-950">Year in Business</p></div>
//          <div className="w-60 h-60 flex flex-col rounded-full shadow-lg justify-center items-center mt-9">
//         <h1 class="text-yellow-500  font-extrabold text-6xl">250</h1>
//         <p class=" font-semibold text-xl  text-blue-950">Mobile App Developers</p>
//         </div>
//         </div> 
//         <div className="flex gap-4">
//     <div class="rounded-full shadow-lg flex flex-col justify-center w-60 h-60  text-center items-center  mt-9">
//         <h1 class="text-yellow-500  font-extrabold text-3xl">500</h1>
//         <p class=" font-semibold text-xl  text-blue-950">Apps Delivered</p></div>
//          <div className="w-60 h-60 flex flex-col rounded-full shadow-lg justify-center items-center mt-9">
//         <h1 class="text-yellow-500  font-extrabold text-6xl">250</h1>
//         <p class=" font-semibold text-xl  text-blue-950">Clients Worldwide</p>
//         </div>
//         </div> 
//      </div>
//      </div>
...
//     <svg
//     className="w-full absolute left-0 h-24 "
//     viewBox="0 0 4937 100"
//     xmlns="http://www.w3.org/2000/svg"
//   >
//     <defs>
...
//     />
//   </svg>   
//     <div className="flex flex-col items-center h-[570px] bg-gray-100  mt-14    ">
//       <h1 className="mt-20 text-center font-bold text-5xl text-blue-950">
//         Trusted by Global Enterprises
//       </h1>
//       <h2 className="mt-4 text-center font-semibold text-2xl text-blue-950  ">
//         At Infoneo we support our customers through agile deliveries and more simplified solutions.
//       </h2>
...
//         <button
//           onClick={prev}
//           className="absolute left-36 bg-white rounded-full shadow  z-20" >
...
//             <div
//               key={i}
//               className="w-60 h-52 bg-white rounded-sm  flex justify-center items-center "
//             >
//               <img
//                 src={img}
//                 alt={`slide-${i}`}
//                 className="w-60 h-52 border border-gray-200 rounded-sm object-contain"
//               />
//             </div>
//           ))}
//         </div>
...
//         <button
//           onClick={next}
//           className="absolute right-36 bg-white rounded-full shadow  z-20" >
...
//       <h1 className="mt-6 text-center font-bold text-5xl text-blue-950">
//       Our Wide-ranging Technology Stack
//       </h1>
//     <p className="text-[19px] font-semibold mt-16 w-[850px] mx-auto text-center text-blue-950">We deploy the newest development Technologies & Frameworks using
//        a systematically-defined agile approach to build your scalable custom business applications in a timely manner. Our development team entails in-depth technology expertise and is perfectly competent 
//        to handle your simple to complex project requirements with absolute effortlessness.</p>
     
//        <div className="flex justify-center mt-10 mx-auto gap-6 mt-3 flex-wrap">
//         <div className="bg-white  items-center flex flex-col rounded-md shadow-md w-60 h-40
//           transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//           <img className="w-24 h-24 " src="src/assets/php-logo.bb5b04a0a132a9a512be.png" alt="" />
//           <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition hover:translate-y-3 ursor-pointer  duration-300 ">PHP</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//       transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//        <img className="w-24 h-24" src="src/assets/flutter-logo.f5928f941cedc0416f41.png" alt="" />
//        <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition hover:translate-y-3  cursor-pointer  duration-300 ">Flutter</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40 
//          transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//         <img className="w-24 h-24" src="src/assets/react-logo.08aa92609e25b3be078f.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition hover:translate-y-3 cursor-pointer  duration-300 ">React Js</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md  shadow-md w-60 h-40 
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer ">
//         <img className="w-24 h-24" src="src/assets/nodejs-logo.8554552a79e2305d4270.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition hover:translate-y-3 cursor-pointer  duration-300 ">Node Js</p>
//       </div>
//         <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40 cursor-pointer
//          transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg ">
//          <img className="w-24 h-24" src="src/assets/express-js-logo.0753fdbd9e3ac30a5a89.png" alt="" />
//          <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">Express Js</p>
//       </div>
//         <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40 cursor-pointer
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg">
//          <img className="w-24 h-24" src="src/assets/laravel-logo.77392bcc0ce40226f7c3.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500  transform transition cursor-pointer  duration-300 hover:translate-y-3">Laravel</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md cursor-pointer shadow-md w-60 h-40         
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//          <img className="w-24 h-24" src="src/assets/figma-logo.6730d6604d7ee8d8fe7e.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">Figma</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//          <img className="w-24 h-24" src="src/assets/python_logo.003220f38009e046bb04.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">Python</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//        transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//          <img className="w-24 h-24" src="src/assets/langgraph_logo.265d8f0502836cef91e1.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3 ">LangGraph</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer  ">
//          <img className="w-24 h-24" src="src/assets/pytorch_logo.f51803954e5c4cbff903.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">Pytroch</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//          transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer ">
//          <img className="w-24 h-24" src="src/assets/langchain_logo.c5ee2032ee6d42216f12.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">LangChain</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//          <img className="w-24 h-24" src="src/assets/Tensorflow_logo.3bcfaf6f32a6f12a6064.png" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300 hover:translate-y-3">Tensorflow</p>
//       </div>
//        <div className="bg-white flex flex-col items-center rounded-md shadow-md w-60 h-40
//         transform transition duration-300 hover:-translate-y-2 hover:rotate-10 hover:shadow-lg cursor-pointer">
//          <img className="w-24 h-24" src="src/assets/n8n-logo-hd.0ef6276fbf326697cf82.webp" alt="" />
//         <p className="text-gray-400 text-[20px] hover:text-gray-500 transform transition cursor-pointer  duration-300  hover:translate-y-3">N8n</p>
...
//                {/* 4th Page */}
//          <img className="mt-36" src="src/assets/download.png" alt="" />  
//         <div className="w-full bg-[#F6FCFF] py-20 flex flex-col items-center">
//       <h1 className="text-center font-bold text-5xl text-blue-950 mb-16">
//         DevSpots Services to Transform Your Business
//       </h1>

//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-center max-w-6xl">
//         {visibleServices.map((service, index) => (
//           <div
//             key={index}
//             className="relative overflow-hidden rounded-2xl cursor-pointer transform transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl">
//             <img
//               src={service.img}
//               alt={service.title}
//               className="w-full h-64 object-cover rounded-2xl transition-transform duration-500" />
//             <div className="absolute top-0 left-3 w-full  text-white text-xl font-bold py-3 ">
//               {service.title}
//             </div>
//           </div>
//         ))}
...
//         <button
//           onClick={() => setShowAll(!showAll)}
//           className="px-8 py-3 bg-blue-700 text-white font-semibold text-lg rounded-full bg-blue-950 transition-all duration-300">
//           {showAll ? "View Less" : "View More"}
//         </button>
//       </div>
//     </div>
...
//           {step.title}
//         </h2>
//         <p className="text-lg text-gray-700 text-center">{step.desc}</p>
//       </div>
//     ))}
//   </div>
// </div>
...
//       Recent Projects </h1>
//        <p className="text-[23px] font-semibold mt-8  mx-auto text-center text-blue-950">
//         We follow a well-defined development procedure to take an application from ideation to actualization, aiming <br/> to provide innovative app development solutions to our clients.
//        </p>
      
//       <div className="flex flex-row w-full justify-center gap-5 mt-10">
//   {[
//     {
//       img: "src/assets/thumbnail.3e3ccf792ad1e6e8f90b.png",
//       title: "Unleash Your Mind with BrainStormer: Exploring the UI Design of a Cutting-Edge Quiz App"
...
//         <button
//           className="  rounded-full w-10 h-10 border border-orange-400 hover:bg-orange-400  ">
